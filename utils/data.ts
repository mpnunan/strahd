...
const createMapLocation = async (payload: MapLocation): Promise<{name: string}> => {
  const mapLocation = await data.post('/maploactions.json', payload);
...
const createSessionNpc = async (payload: SessionNpc): Promise<{name: string}> => {
...
const createSessionMapLocation = async (payload: SessionMapLocation): Promise<{name: string}> => {
